...
| [Scriptorium](https://github.com/Fzkuji/Scriptorium) | **Agent Memory** — stores and retrieves agent memories as readable Markdown notes, with facts cited to source messages and MCP access. Successor to Wiki Agent. |
