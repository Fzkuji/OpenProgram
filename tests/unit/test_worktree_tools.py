...
def test_bash_uses_worktree_cwd(worktree_root, monkeypatch):
    ...
    import sys
    import openprogram.programs.functions.bash.bash  # noqa: F401
    bash_inner = sys.modules["openprogram.programs.functions.bash.bash"]
    ...
    from openprogram.programs.functions.bash import bash as bash_tool
...
def test_write_resolves_relative_inside_worktree(worktree_root):
    from openprogram.programs.functions.write import write as write_tool
...
def test_read_resolves_relative_inside_worktree(worktree_root):
    from openprogram.programs.functions.read import read as read_tool
...
def test_edit_resolves_relative_inside_worktree(worktree_root):
    from openprogram.programs.functions.edit import edit as edit_tool
    out = _exec_tool(
