...
from openprogram.programs.functions.browser import browser as tool
...
def fake_playwright(monkeypatch):
    ...
    from openprogram.programs.functions.browser import _chrome_bootstrap as boot
...
def test_bootstrap_chrome_binary_returns_path_or_none():
    import os as _os
    from openprogram.programs.functions.browser._chrome_bootstrap import chrome_binary
...
def test_bootstrap_real_user_data_dir_is_platform_specific():
    from openprogram.programs.functions.browser._chrome_bootstrap import real_user_data_dir
...
def test_bootstrap_sidecar_dir_under_dot_openprogram():
    from openprogram.programs.functions.browser._chrome_bootstrap import sidecar_dir
    p = sidecar_dir()
...
def test_bootstrap_port_file_under_dot_openprogram():
    from openprogram.programs.functions.browser._chrome_bootstrap import port_file
    p = port_file()
    assert ".openprogram" in str(p)
...
def test_bootstrap_is_port_listening_negative():
    from openprogram.programs.functions.browser._chrome_bootstrap import is_port_listening
...
def test_bootstrap_read_last_used_profile_default(tmp_path):
    from openprogram.programs.functions.browser._chrome_bootstrap import read_last_used_profile
...
def test_bootstrap_lock_path_under_dot_openprogram():
    from openprogram.programs.functions.browser._chrome_bootstrap import _bootstrap_lock_path
