...
from openprogram.programs.functions.vanilla.agents.agent.job_output.job_output import _job_output_impl
from openprogram.programs.functions.vanilla.agents.agent.job_stop.job_stop import job_stop
...
def test_job_stop_returns_post_cancel_resource_view(monkeypatch) -> None:
    ...
    _with_runner(monkeypatch, runner)
    monkeypatch.setattr(
        "openprogram.programs.functions.vanilla.agents.agent._ownership.check_job_ownership",
        lambda *_args: None,
    )
