...
from openprogram.programs.functions.vanilla.agents.agent._ownership import check_job_ownership
...
def test_ownership_rejects_foreign_session(parent_turn):
    ...
    from openprogram.agent.job.store import save_job
    from openprogram.agent.job.types import Job, JobStatus
    from openprogram.programs.functions.vanilla.agents.agent.job_output.job_output import (
        _job_output_impl,
    )
