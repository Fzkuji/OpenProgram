...
backup_before_edit twice in the same turn doesn't double-back).
"""
...
from openprogram.store.file_backup.manifest import entries, load
from openprogram.store.file_backup.paths import turn_manifest_path
...
def test_restore_missing_backup_is_skipped(session_dir, workdir):
    ...
    from openprogram.store.file_backup.paths import turn_backup_dir
