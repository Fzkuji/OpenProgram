...
esbuild.build({
  ...
  stdin: {
    contents: [
      ...
      'export { recordOperationCue, resetBrowserControl } from "./lib/state/browser-control.ts";',
      'export { ingestBrowserResource, resetBrowserResources, setBrowserConnection } from "./lib/state/session-resources.ts";',
    ].join("\n"),
    resolveDir: web,
    loader: "tsx",
  },
