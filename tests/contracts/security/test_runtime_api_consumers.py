...
def test_fal_200_error_envelope_omits_peer_mapping(monkeypatch, failure):
    from openprogram.programs.functions.image_generate.providers import fal
...
def test_minimax_200_error_envelope_omits_peer_status_message(monkeypatch):
    from openprogram.programs.functions.web_search.providers import minimax
...
def test_web_search_malformed_status_hides_signed_url_and_peer_echo(
    ...
    from openprogram.programs.functions.web_search.providers import brave
...
def test_brave_rejects_non_2xx_without_leaking_signed_url_or_body(
    ...
    from openprogram.programs.functions.web_search._http import ProviderHTTPError
    from openprogram.programs.functions.web_search.providers import brave
...
def test_image_api_4xx_body_hides_credentials_and_signed_url(
    ...
    from openprogram.programs.functions.image_generate.providers import openai
...
def test_web_search_adapters_use_registry_managed_http(
    ...
    module = importlib.import_module(
        f"openprogram.programs.functions.web_search.providers.{module_name}"
    )
...
@pytest.mark.parametrize(
    ...
    [
        (
            "openprogram.programs.functions.image_generate.providers.fal",
            "FalProvider",
            "generate",
        ),
        (
            "openprogram.programs.functions.image_generate.providers.gemini",
            "GeminiImagenProvider",
            "generate",
        ),
        (
            "openprogram.programs.functions.image_generate.providers.openai",
            "OpenAIImageProvider",
            "generate",
        ),
        (
            "openprogram.programs.functions.image_analyze.providers.anthropic",
            "AnthropicVisionProvider",
            "analyze",
        ),
        (
            "openprogram.programs.functions.image_analyze.providers.gemini",
            "GeminiVisionProvider",
            "analyze",
        ),
        (
            "openprogram.programs.functions.image_analyze.providers.openai",
...
def test_configured_search_keeps_credential_on_exact_origin_and_rejects_redirect(
    ...
    from openprogram.programs.functions.web_search.providers import ollama
