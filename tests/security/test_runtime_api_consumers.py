...
def test_image_api_4xx_body_hides_credentials_and_signed_url(
    ...
    from openprogram.functions.tools.image_generate.providers import openai
...
def test_web_search_adapters_use_registry_managed_http(
    ...
    module = importlib.import_module(
        f"openprogram.functions.tools.web_search.providers.{module_name}"
    )
...
@pytest.mark.parametrize(
    ...
    [
        (
            "openprogram.functions.tools.image_generate.providers.fal",
            "FalProvider",
            "generate",
        ),
        (
            "openprogram.functions.tools.image_generate.providers.gemini",
            "GeminiImagenProvider",
            "generate",
        ),
        (
            "openprogram.functions.tools.image_generate.providers.openai",
            "OpenAIImageProvider",
            "generate",
        ),
        (
            "openprogram.functions.tools.image_analyze.providers.anthropic",
            "AnthropicVisionProvider",
            "analyze",
        ),
        (
            "openprogram.functions.tools.image_analyze.providers.gemini",
            "GeminiVisionProvider",
            "analyze",
        ),
        (
            "openprogram.functions.tools.image_analyze.providers.openai",
