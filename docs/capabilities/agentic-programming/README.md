...
- [`openprogram/skills_bundled/agentic-programming/SKILL.md`](https://github.com/Fzkuji/OpenProgram/blob/main/packages/core/src/openprogram/skills_bundled/agentic-programming/SKILL.md) — the bundled skill an agent follows to write/validate functions (file layout, rule checklist, smoke tests)
