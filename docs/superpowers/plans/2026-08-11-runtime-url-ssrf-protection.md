...
**Files:**
- Modify: `openprogram/functions/tools/web_fetch/web_fetch.py`
- Modify: `openprogram/channels/_attachments.py`
- Modify: `openprogram/channels/_transport.py`
- Modify: `openprogram/functions/tools/image_generate/image_generate.py`
- Modify: `openprogram/functions/tools/image_analyze/providers/gemini.py`
...
uv run ruff check openprogram/functions/tools/web_fetch openprogram/channels openprogram/functions/tools/image_generate openprogram/functions/tools/image_analyze tests/security/test_runtime_derived_url_consumers.py
```
...
```bash
git add openprogram/functions/tools/web_fetch openprogram/channels openprogram/functions/tools/image_generate openprogram/functions/tools/image_analyze tests
...
**Files:**
- Modify: `openprogram/functions/tools/web_search/_http.py`
- Modify: `openprogram/functions/tools/web_search/providers/brave.py`
- Modify: `openprogram/functions/tools/web_search/providers/exa.py`
- Modify: `openprogram/functions/tools/web_search/providers/firecrawl.py`
- Modify: `openprogram/functions/tools/web_search/providers/google.py`
- Modify: `openprogram/functions/tools/web_search/providers/minimax.py`
- Modify: `openprogram/functions/tools/web_search/providers/moonshot.py`
- Modify: `openprogram/functions/tools/web_search/providers/ollama.py`
- Modify: `openprogram/functions/tools/web_search/providers/perplexity.py`
- Modify: `openprogram/functions/tools/web_search/providers/searxng.py`
- Modify: `openprogram/functions/tools/web_search/providers/tavily.py`
- Modify: `openprogram/functions/tools/image_generate/providers/fal.py`
- Modify: `openprogram/functions/tools/image_generate/providers/gemini.py`
- Modify: `openprogram/functions/tools/image_generate/providers/openai.py`
- Modify: `openprogram/functions/tools/image_analyze/providers/anthropic.py`
- Modify: `openprogram/functions/tools/image_analyze/providers/gemini.py`
- Modify: `openprogram/functions/tools/image_analyze/providers/openai.py`
...
uv run ruff check openprogram/functions/tools/web_search openprogram/functions/tools/image_generate/providers openprogram/functions/tools/image_analyze/providers openprogram/skills openprogram/plugins openprogram/updater openprogram/webui/routes/mcp.py openprogram/webui/_model_listing tests/security
```
...
```bash
git add openprogram/functions openprogram/skills openprogram/plugins openprogram/updater openprogram/webui tests
