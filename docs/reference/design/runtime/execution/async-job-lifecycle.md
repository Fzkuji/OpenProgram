...
| 9 | `openprogram/programs/functions/agent/agent/agent.py` | `_agent_impl` internally switches to `submit_agent_task` + defaults to foreground; returns job_id when `run_in_background=True` |
