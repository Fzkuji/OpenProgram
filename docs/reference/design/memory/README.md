...
| [`speaker-identity.html`](speaker-identity.html) | Visualization: how several people share one session, where speaker identity breaks on the way to memory, and the seven files that carry it through (designed, not built) |
