...
def _probe_pdf_tools() -> None:
    ...
    from openprogram.programs.functions.vanilla.web.pdf import execute as pdf_extract
    from openprogram.programs.functions.vanilla.files.read import _read_pdf
