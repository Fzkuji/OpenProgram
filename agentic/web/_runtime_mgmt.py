...
def _log(text: str) -> None:
    try:
        from agentic.web.server import _log as _srv_log
        _srv_log(text)
    except Exception:
        print(text)
...
def _broadcast(msg: str) -> None:
    try:
        from agentic.web.server import _broadcast as _srv_bc
        _srv_bc(msg)
    except Exception:
        pass
...
def _broadcast_chat_response(conv_id: str, msg_id: str, response: dict) -> None:
    try:
        from agentic.web.server import _broadcast_chat_response as _srv_bcr
...
def _get_conversations():
    ...
    from agentic.web.server import _conversations, _conversations_lock
