...
const browserTest = readFileSync(new URL("../tests/file-draft-store.browser.test.mjs", import.meta.url), "utf8");
...
assert.match(browserTest, /IndexedDbDraftStore/);
assert.match(browserTest, /esbuild\.build/);
assert.doesNotMatch(browserTest, /const mutate =/);
