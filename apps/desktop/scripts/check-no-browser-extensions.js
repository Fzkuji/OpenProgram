...
const builtinPane = read("apps/web/components/center-tabs/panes/builtin-tab-pane.tsx");
const browserControls = read("apps/web/components/center-tabs/browser/browser-controls.tsx");
const webTabPane = read("apps/web/components/center-tabs/browser/web-tab-pane.tsx");
