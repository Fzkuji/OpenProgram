...
async function managerChecks() {
  ...
  const controlsSource = fs.readFileSync(path.join(repositoryRoot, "apps/web/components/center-tabs/browser-controls.tsx"), "utf8");
  const paneSource = fs.readFileSync(path.join(repositoryRoot, "apps/web/components/center-tabs/builtin-tab-pane.tsx"), "utf8");
  const webTabSource = fs.readFileSync(path.join(repositoryRoot, "apps/web/components/center-tabs/web-tab-pane.tsx"), "utf8");
