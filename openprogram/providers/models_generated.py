...
MODELS: dict[str, Model] = {
    ...
    # ── Claude Code CLI (subscription-based via `claude` CLI) ─────────────────
    "claude-code/claude-opus-4-5": Model(
        id='claude-opus-4-5',
        name='Claude Opus 4.5',
        api='claude-code-cli',
    ...
    "claude-code/claude-sonnet-4-5": Model(
        id='claude-sonnet-4-5',
        name='Claude Sonnet 4.5',
        api='claude-code-cli',
        provider='claude-code',
    ...
    "claude-code/claude-haiku-4-5": Model(
        id='claude-haiku-4-5',
        name='Claude Haiku 4.5',
        api='claude-code-cli',
        provider='claude-code',
