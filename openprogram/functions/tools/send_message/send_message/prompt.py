...
DESCRIPTION = (
    ...
    "trigger it to respond. HEAD names the BRANCH (any node on it works, "
    "even a head that has since moved on) — delivery always lands on the "
    "branch's current tip, never forks off history. To fork off a "
    "specific node, use to=\"new:SID:MSG_ID\". If the target is busy "
    "running a turn, the message is queued and processed when that turn "
    "ends.\n"
