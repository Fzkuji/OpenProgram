...
DESCRIPTION = (
    ...
    "and you get a task_id back immediately — task_output waits for "
    "the result, task_stop withdraws or cancels it, and the result "
    "also comes back to you automatically. 'to' is mutually exclusive "
    "with context, and run_in_background is ignored (always async). "
