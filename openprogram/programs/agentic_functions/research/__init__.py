...
from openprogram.programs.agentic_functions.research.pipeline import research_pipeline, STAGES
from openprogram.programs.agentic_functions.research.evaluate import compete
