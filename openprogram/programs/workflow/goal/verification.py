...
The Programs panel shows a single entry, :func:`goal`, and the
deterministic continuation loop in this package calls the same
verification path each turn. There is only this one judgment, and only
...
stays in this package's control-flow modules, outside the LLM.
"""
...
# ---------------------------------------------------------------------------
# Internal completion verification (docstring = prompt)
# ---------------------------------------------------------------------------
