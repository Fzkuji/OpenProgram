...
def _dispatch_to_existing(
    ...
    from openprogram.programs.functions.vanilla.send_message.send_message.addressing import (
    ...
    from openprogram.programs.functions.vanilla.send_message.shared import _emit_branch_ui
    emit_safe(
        "branch.message_sent",
        "agent",
