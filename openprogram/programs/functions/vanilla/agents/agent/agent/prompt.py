...
DESCRIPTION = (
    ...
    "(run_in_background=false, default) or a job_id to await later "
    ...
    "and you get a job_id back immediately — job_output waits for "
    "the result, job_stop withdraws or cancels it, and the result "
    ...
    "result with job_output(job_id), or stop the agent early with "
    "job_stop(job_id). Ignored when 'to' is set.\n"
